...
public interface NegocioTDA extends Remote {
	...
	// TODO: el proveedor hay que meterlo en el producto (abstracto) y modificar la
	// entity tambien!, el crear plato (no semielaborado) tiene que recibir el
	// proveedor tambien, solo el nombre y validar que exista
