...
@Entity
@DiscriminatorValue("depostitoRestaurant")
public class DepositoRestaurantEntity extends DepositoEntity {
	...
	public DepositoRestaurantEntity(String nombre, List<PedidoReposicionEntity> pedidosReposicion, List<InsumoEntity> insumos, EmpleadoEntity empleado) {
