...
public class MesaAgregarProductoServlet extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} catch (ProductoNoExisteException | ProductoSinStockException | InsumoNoExisteException | ConexionException | MesaOcupacionNoExisteException | BaseDeDatosException e) {
